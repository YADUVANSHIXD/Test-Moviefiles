...
auth_channel = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002245438957 -1002049206050').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
